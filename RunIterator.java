...
public class RunIterator implements Iterator {
  ...
  // the encoding.
  public RunIterator(DListNode1 rle) {
    // Your solution here.  You may add parameters to the method signature.
	rleNode = rle;	//on construction, set the current node to the head of the runlist
  }
  ...
  public boolean hasNext() {
    ...
    return rleNode != null;	//if rleNode is null then there is no new element
  }
   ...
   */
  public void remove() {
    throw new UnsupportedOperationException();	// lol \o/
  }
}